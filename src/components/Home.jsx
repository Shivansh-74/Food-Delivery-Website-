    ...
    <div className='w-[100%] '>
            ...
            {/** why us */}
                ...
                <GiHotMeal className='md:text-7xl text-5xl'/>
                 ...
                 <div className='text-center'>
                 <h1 className='font-bold text-2xl py-[10px]'>Qulity Food</h1>
                ...
                <Card img="https://www.awesomecuisine.com/wp-content/uploads/2009/06/Plain-Dosa.jpg" name="Masala Dosa" price="120" />
                <Card img="https://dukaan.b-cdn.net/700x700/webp/projecteagle/images/3b9eb5da-6bd2-4d4f-9bf2-8a594cc7159f.jpg" name="Nudels" price="Rs-98" />
                ...
                <Card img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSqFHMCZ7CnPo5NEqxOwyckoODeiRyLxYmiHg&s" name="Chole Bhature" price="298" />
                ...
                <div className='h-[400px] col-span-3 '>
                 ...
                 <h6 className='text-1xl text-gray-950 my-3 py-2'> Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam, voluptatum distinctio at </h6>
                ...
                <div className='h-[400px] col-span-2  p-6'>
                <img src="https://img.freepik.com/premium-photo/noodles-white-background_894067-20380.jpg" alt="" className='mix-blend-multiply md:w-[100%] md:h-[100%] h-[100%] w-[100%] md:m-4 p-4 mx-auto '/>
                </div>
